...
export function BottomNav() {
  ...
  return (
    <>
      {/* Full-width background slab that covers the safe area and fills the
          gap between the pill and the physical bottom edge of the screen */}
      <div
        className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-[#0a0a0a]"
        style={{ height: 'calc(4rem + env(safe-area-inset-bottom, 0px))' }}
      />

      <nav
        className="lg:hidden fixed bottom-0 left-0 right-0 z-50 flex justify-center px-6 pt-2"
